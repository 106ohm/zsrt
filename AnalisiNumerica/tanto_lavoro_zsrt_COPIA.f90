...
real(dp), dimension(:), allocatable :: alfr, alfi, beta, v
...
allocate( T(1:2,0:1), S(1:2,0:1) )
allocate( Eigenvalues(2,1) )
allocate( v(2) )
allocate( Teispack(1:2,1:2), Seispack(1:2,1:2) )
allocate( alfr(2), alfi(2), beta(2), z(2,2) )
...
CALL PGENV(0.,kMax*1.0,0.0,maxTotError,0,1)
