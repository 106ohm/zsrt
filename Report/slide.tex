...
\begin{frame}[label=BeforeSturmSequence]
  ...
  \begin{os}[ important \hyperlink{SturmSequence}{\beamergotobutton{results}} in Appendix]
...
\begin{frame}
  ...
  In this case we plot\symbolfootnote[1]{for $n=2^k$ with $k=1,\dots,9$} the absolute module of $\frac{\text{larger error}}{\text{larger eigenvalues}}$ 
